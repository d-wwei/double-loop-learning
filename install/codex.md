...
If First Principles or other cognitive bases are already in your `AGENTS.md`, place Double-Loop Learning AFTER them. Order:
1. First Principles (reasoning input layer)
2. Double-Loop Learning (reflection quality layer)
